echo "================================ Compile Golang Server to Mac OS ================================"
...
echo "Release: $name $version (MacOS) $nowDT" >  "$releaseName"/"$releaseNote"
...
echo "Packaging..."
tar -zcvf "$releaseName"_darwin.tar.gz "$releaseName"
tar="$releaseName"_darwin.tar.gz
echo "Ready! :) --> $tar"
